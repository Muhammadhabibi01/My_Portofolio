<?php include('config.php'); ?>
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				...
				if($sql){
					echo '<script>alert("Berhasil menambahkan data."); document.location="index.php?page=tampil_ps";</script>';
				}else{
		...
		<form action="tambah.php" method="post">
			...
			<div class="item form-group">
				<div  class="col-md-6 col-sm-6 offset-md-3">
					<input type="submit" name="submit" class="btn btn-primary" value="Simpan" disabled="disabled">
			</div>
		</form>
	</div>
