<?php
  ...
  if(!isset($_SESSION['nama'])){
    echo "Ooooooopsss....Sepertinya Anda Belum Login.Silahkan<a href='login.php'>Login Dulu Yaaah!</a>";
  }else{
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Data Pasien <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index2.php?page=tampil_ps2">Tampil Data</a></li>
                      <li><a href="index2.php?page=tambah_ps2">Tambah Data</a></li>
                    </ul>
                  </li>&nbsp;
                  ...
                  <li><a><i class="fa fa-hospital-o"></i> Info Penting <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index2.php?page=tablers_ps2">Rumah Sakit Rujukan</a></li>
                      <li><a href="index2.php?page=edukasi_ps2">Edukasi</a></li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  ...
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item"  href="index.php"><i class="fa fa-sign-out pull-right"></i> Logout</a>
                  </div>
                </li>
              </ul>
            </nav>
